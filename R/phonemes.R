...
#' @description A dataset containing an extensive set of phonemes that can be transcribed from IPA or SAMPA to jTRACE notation using approximations.
#' @docType data
#' @usage data(phonemes)
...
#'   \item{approximation}{Closest IPA phoneme this phoneme will be collapsed into}
#'   \item{sampa}{Phoneme symbol in SAMPA notation}
#'   \item{trace}{Phoneme in jTRACE notation},
